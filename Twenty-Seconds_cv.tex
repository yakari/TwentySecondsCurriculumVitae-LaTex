...
\profilepic{yann_poirier.jpg} % Profile picture
...
\skills{{Python $\textbullet$ \large \LaTeX / 3}, {Ansible / 3}, {Perl $\textbullet$ Shell scripting / 3.5}, {SQL / 4.5}, {Jenkins $\textbullet$ Gitlab / 4.5}, {Typescript $\textbullet$ Angular $\textbullet$ JavaScript / 5}, {Java 8 - 9 $\textbullet$ Spring Boot / 5.5}}
